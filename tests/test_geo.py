...
class TestGeo(unittest.TestCase):
    ...
    def test_points_between(self):
        ...
        dist, la, lo, b = points_between(start, end, 10)
        ...
        dist, la, lo, b = points_between(start, end, 10, True)
    ...
    def test_path_to_points(self):
        points = [[1, 1], [10, 10]]
        dist, t, lat, lon, b = path_to_points(points, n=10, times=None)
        ...
        points = [[0, 0], [10, 10], [20, 20]]
        dist, t, lat, lon, b = path_to_points(points, n=10, times=[0, 1])
        self.assertAlmostEqual(lat[-1], 20.0, places=1)
        self.assertAlmostEqual(lon[-1], 20.0, places=1)
