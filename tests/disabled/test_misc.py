...
class TestMisc(unittest.TestCase):
    ...
    def test_points(self, m):
        ...
        self.assertEqual(
            result["features"][0],
            {
                ...
                "type": "Feature",
                "properties": {"resolution": 0, "type": "point", "name": "Place 1"},
            },
        )
    ...
    def test_lines(self, m):
        ...
        self.assertEqual(
            result["features"][0],
            {
                ...
                "type": "Feature",
                "properties": {"resolution": 0, "type": "line", "name": "Line 1"},
            },
        )
    ...
    def test_areas(self, m):
        ...
        self.assertEqual(len(result["features"]), 1)
        self.maxDiff = None
        coordinates = np.array(result["features"][0]["geometry"]["coordinates"])
