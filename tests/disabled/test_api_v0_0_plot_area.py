...
class SetUpTest:
    def basic(self):
        return {"datasets": "giops_day", "variables": "votemper"}
                ...
                for variable in test_data["variables"][dataset]:
                    ...
                    with self.app:
                        if (
                            variable != "aice"
                            and variable != "vice"
                            and variable != "u-component_of_wind_height_above_ground"
                            and variable != "v-component_of_wind_height_above_ground"
                        ):
            ...
            "area": [
                {
                    ...
                    "polygons": [
                        [
                            [81.9641869418678, -133.6425517966064],
                            [82.11743931633454, 135.86305129514767],
                            [82.67199662955888, 45.34981083477634],
                            [82.78990487718798, -46.8784673479203],
                            [81.9641869418678, -133.6425517966064],
                        ]
                    ],
                }
            ...
            "area": [
                {
                    ...
                    "polygons": [
                        [
                            [57.11339105173794, -132.47947058574835],
                            [56.61203448644936, 132.90545629119978],
                            [60.17446632157565, 54.64271180479035],
                            [59.72661157286756, -54.263248927685616],
                            [57.11339105173794, -132.47947058574835],
                        ]
                    ],
                }
            ...
            "area": [
                {
                    ...
                    "polygons": [
                        [
                            [-85.85028882090575, -39.76266439190479],
                            [-74.93765711817481, -10.310127834772654],
                            [-67.91777986984644, -46.242015910188734],
                            [-74.12193655478347, -75.61829643434633],
                            [-85.85028882090575, -39.76266439190479],
                        ]
                    ],
                }
            ...
            "area": [
                {
                    ...
                    "polygons": [
                        [
                            [-75.62422320523663, -39.28601952893509],
                            [-75.13422316699835, 43.14268901535596],
                            [-75.65066621622204, 129.2753475005572],
                            [-77.28252964129544, -134.93946274708324],
                            [-75.62422320523663, -39.28601952893509],
                        ]
                    ],
                }
            ...
            "area": [
                {
                    ...
                    "polygons": [
                        [
                            [-54.566783409368874, -48.036019835037585],
                            [-54.66719048575525, 48.06451402538198],
                            [-57.11884003157999, 125.80658230401663],
                            [-57.418019528611666, -126.68054845147387],
                            [-54.566783409368874, -48.036019835037585],
                        ]
                    ],
                }
            ...
            "area": [
                {
                    ...
                    "polygons": [
                        [
                            [48.28525379709447, -203.64551749789578],
                            [48.72020809096932, -148.83137396159498],
                            [27.569833237584163, -148.83137396159498],
                            [27.569833237584163, -202.9890606890778],
                            [48.28525379709447, -203.64551749789578],
                        ]
                    ],
                }
