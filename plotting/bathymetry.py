...
class BathPlotter(Plotter):
    ...
    def plot(self):
        ...
        my_plot_div = plot({
            "data": [Surface(z=bathymetry, x=self.longitude, y=self.latitude, colorscale='Earth', colorbar={"len":1, "x":-0.5}, showscale=True), Surface(z=data, x=self.longitude, y=self.latitude, colorscale='Electric', showscale=True)],
            "layout": layout
        }, output_type='div',)
