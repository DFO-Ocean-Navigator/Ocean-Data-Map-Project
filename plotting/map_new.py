...
class MapPlotterNew(PlotterNew):
    ...
    def odv_ascii(self):
        ...
        return super(MapPlotterNew, self).odv_ascii(
            self.dataset_name,
            [self.variable_name],
            [self.variable_unit],
            station,
    ...
    def csv(self):
        ...
        return super(MapPlotterNew, self).csv(header, columns, data)
    ...
    def plot(self):
        ...
        return super(MapPlotterNew, self).plot(fig)
