    ...
    render() {
        ...
        return (
            <div className='MapInputs'>
                ...
                <ComboBox key='basemap' id='basemap' state={this.props.state.basemap} onUpdate={this.props.changeHandler} data={[
                    {id: 'topo', value: _('ETOPO1 Topography'), attribution: 'Topographical Data from ETOPO1 1 Arc-Minute Global Relief Model. NCEI, NESDIR, NOAA, U.S. Department of Commerce'},
