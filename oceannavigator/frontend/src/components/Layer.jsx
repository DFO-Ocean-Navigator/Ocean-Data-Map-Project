...
*/
  ...
  */
  ...
  render() {
    ...
    let panelName = 'Ocean'
    if (this.props.datasetconfig !== undefined && this.props.datasetconfig !== null && this.state.current_dataset === undefined && this.state.current_dataset === None && this.state.current_variable !== undefined) {
