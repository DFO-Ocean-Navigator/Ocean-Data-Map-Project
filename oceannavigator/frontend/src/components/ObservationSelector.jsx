      ...
      <div className="ObservationSelector">
        ...
        <Card>
          <Card.Header>
            ...
            <Form.Check type="switch" id="platform-toggle" onClick={() => {}} />
          </Card.Header>
          {/* <Card.Collapse
            onEnter={() => {
              this.fetchMetaKeys();
            ...
            <div className="inputs">
              ...
              <div className="input" style={{ width: "30em" }}>
                ...
                {/* <Autosuggest
                    ...
                    inputProps={{
                      value: this.state.meta_value,
                      onChange: (evt, v) =>
                        this.setState({ meta_value: v.newValue }),
                    }}
                  /> */}
              </div>
            </div>
        ...
        <Card>
          ...
          {/* <Card.Collapse onEnter={() => this.setState({ depthActive: true })}> */}
            {/* <Header.Body> */}
              <div className="inputs">
                <div style={{ width: "95%", margin: "0 auto" }}>
                  <Slider
