...
class DrifterWindow extends React.Component {
    ...
    render() {
        ...
        var buoyvariable = <ComboBox key='buoyvariable' id='buoyvariable' multiple state={this.state.buoyvariable} def='' onUpdate={this.onLocalUpdate.bind(this)} url={'/api/drifters/vars/' + this.props.drifter} title={_('Buoy Variable')}><h1>Buoy Variable</h1></ComboBox>;
        var variable = <ComboBox key='variable' id='variable' multiple state={this.state.variable} def='' onUpdate={this.onLocalUpdate.bind(this)} url={'/api/variables/?dataset='+this.props.dataset} title={_('Variable')}><h1>Variable</h1></ComboBox>;
        ...
        var showmap = <SelectBox key='showmap' id='showmap' state={this.state.showmap} onUpdate={this.onLocalUpdate.bind(this)} title={_('Show Map')}>Shows the drifter track on the mini map.</SelectBox>;
        var latlon = <SelectBox key='latlon' id='latlon' state={this.state.latlon} onUpdate={this.onLocalUpdate.bind(this)} title={_('Show Latitude/Longitude Plots')}>Generates plots of the latitude and longitude vs time.</SelectBox>;
