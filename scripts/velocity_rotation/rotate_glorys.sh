# Script to rotate glorys V4 files
...
#Usage: bash rotate_glorys.sh YYYY LOGFILE
...
# Directory stucture
OUT=/data/hdd/glorys/v4/v4/MONTHLY_${date}/rotated/
FILES=/data/hdd/glorys/v4/v4/MONTHLY_${date}/*gridU.nc
ICEFILES=/data/hdd/glorys/v4/v4/MONTHLY_${date}/*icemod.nc
